		...
		return (
			<section className="items-center justify-center pb-12 2xl:pb-18 pt-2 overflow-hidden">
				<div className="text-mainRed">
					<div className="flex justify-center py-6 xl:pb-4 xl:pt-4"><h1 className="text-mainYellow uppercase text-8xl font-black">Video</h1></div>
					<Swiper
					spaceBetween={35}
					slidesPerView={1.25}
					loop={true}
					...
					>
						<SwiperSlide>
							<Card>
								<a href="https://fedorporttest.netlify.app/a">
